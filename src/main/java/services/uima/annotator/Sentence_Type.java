...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("services.uima.annotator.Sentence");
  ...
  public String getIdentifier(int addr) {
      ...
      jcas.throwFeatMissing("Identifier", "services.uima.annotator.Sentence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("Text", "services.uima.annotator.Sentence");
