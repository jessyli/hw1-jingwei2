...
public class GeneTag_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("services.uima.annotator.GeneTag");
  ...
  public String getIdentifier(int addr) {
      ...
      jcas.throwFeatMissing("identifier", "services.uima.annotator.GeneTag");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "services.uima.annotator.GeneTag");
